        ...
        for (const publishConfig of publishConfigs) {
            ...
            if (packager.platform === (_electronBuilderCore || _load_electronBuilderCore()).Platform.MAC) {
                ...
                yield (0, (_fsExtraP || _load_fsExtraP()).outputJson)(updateInfoFile, {
                    version: version,
                    url: computeDownloadUrl(publishConfig, packager.generateName2("zip", "mac", isGitHub), version, { os: (_electronBuilderCore || _load_electronBuilderCore()).Platform.MAC.buildConfigurationKey, arch: (_electronBuilderCore || _load_electronBuilderCore()).Arch[(_electronBuilderCore || _load_electronBuilderCore()).Arch.x64] })
                }, { spaces: 2 });
