...
class NsisTarget extends (_electronBuilderCore || _load_electronBuilderCore()).Target {
    ...
    doBuild(appOutDir, arch) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            const archiveFile = _path.join(_this.outDir, `${packager.appInfo.name}-${packager.appInfo.version}-${(_electronBuilderCore || _load_electronBuilderCore()).Arch[arch]}.nsis.7z`);
    ...
    buildInstaller() {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            for (const _ref of _this3.archs) {
                ...
                defines[arch === (_electronBuilderCore || _load_electronBuilderCore()).Arch.x64 ? "APP_64" : "APP_32"] = yield file;
            }
            ...
            packager.dispatchArtifactCreated(installerPath, _this3, `${packager.appInfo.name}-Setup-${version}.exe`);
        })();
    }
    executeMakensis(defines, commands, isInstaller, originalScript) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            if (fileAssociations.length !== 0) {
                if (_this4.options.perMachine !== true) {
